import { SCHEMA_VERSION, type StoryDoc } from "@/types";
  ...
  world: [
    {
      ...
      refs: [
        { kind: "IMAGE", label: "City skyline" },
        { kind: "NOTE", label: "Tide schedule" },
      ],
    },
    {
      id: "w2",
      ...
      refs: [{ kind: "NOTE", label: "Rules of the harbor" }],
    },
    {
      id: "w3",
      cat: "Faction",
    ...
    },
    {
      ...
      refs: [{ kind: "IMAGE", label: "Salt-ink sample" }],
    },
  ],
  series: [
    {
    ...
    },
    {
      ...
      outline: [
        "The harbor that remembers",
        "Sela’s debt collected",
        "The road that drinks",
        "What Bram drowned",
        "A map drawn in two hands",
      ],
    },
    {
      id: "b3",
      ...
      outline: ["The unmappable sea", "Mother’s hand", "The final quay", "Redrawing the coast"],
    },
  ],
  chapters: [
    {
      ...
      refs: [
        { kind: "IMAGE", label: "Tide-chart sketch" },
        { kind: "NOTE", label: "Map symbology key" },
      ],
    },
    {
      ...
      refs: [{ kind: "NOTE", label: "Cellar floorplan" }],
    },
    {
      ...
      sceneLinks: ["therefore", "but"],
      refs: [{ kind: "IMAGE", label: "Sela reference" }],
    },
    {
      ...
      refs: [{ kind: "NOTE", label: "Barge crew notes" }],
    },
    {
      ...
      sceneLinks: ["but", "therefore"],
      refs: [
        { kind: "IMAGE", label: "Harbor matte" },
        { kind: "NOTE", label: "Who betrays whom" },
      ],
    },
    {
    ...
    },
    {
      ...
      sceneLinks: ["therefore", "therefore"],
      refs: [{ kind: "IMAGE", label: "Final harbor" }],
    },
  ],
  links: [
    ...
    { fromId: "c7", toId: "c8", type: "therefore", alt: "but" },
  ],
};
